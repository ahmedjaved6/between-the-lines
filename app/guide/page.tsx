    ...
    <div className="page-transition lantern-glow-subtle" style={{ minHeight: '100vh' }}>
      <div className="content-with-margin">
        ...
        <div className="main-content">
          ...
          {!guideApplied ? (
            <>
              ...
              {wizardOpen && (
                <div id="wizard-container" className="open" style={{ scrollMarginTop: '80px' }}>
                  ...
                  <span className="wiz-eyebrow" dangerouslySetInnerHTML={{ __html: WIZ_STEPS[wStep].eye }}></span>
                  ...
                  <textarea 
                    ...
                    aria-label={WIZ_STEPS[wStep].title}
                  />
        ...
        <div className="marginalia marginalia-right" aria-hidden="true">
          <div className="margin-item" style={{ marginTop: '160px' }}><i className="fas fa-compass" style={{ opacity: 0.3 }}></i></div>
